...
<table border="1" style="width:500px">
	<tr>
		...
		<td><input style="text" name="name" id="name" size="40" value="${dto.name}"/></td>
	</tr>
	<tr>
		<td style="text-align:center;background-color:cyan">이메일</td>
		<td><input style="text" name="email" id="email" size="40" value="${dto.email}"/></td>
	</tr>
	<tr>
		<td style="text-align:center;background-color:cyan">비밀번호</td>
		<td><input type="password" name="passwd" id="passwd"
			size="40" value="${dto.passwd}"/></td>
	</tr>
	<tr align="center">
	...
	<tr align="center">
		<td colspan="2">
			...
			'${path}/guestbook_servlet/list.do';"/>
		</td>
	</tr>	
</table>
</form>
